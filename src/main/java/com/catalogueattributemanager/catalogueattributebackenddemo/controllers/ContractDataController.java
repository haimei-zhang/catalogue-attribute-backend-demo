...
public class ContractDataController {
    ...
    public List<ContractData> updateContractData(@RequestBody ContractData contractDataItem) {
        ...
        modifiedContractData.setArchive(contractDataItem.getArchive());
        return this.contractData;
    }
    ...
    List<ContractData> buildContractDataList() {
        ...
        ContractData contractData1 = buildContractData(1L, "CONTRACT", "DEF456", "Contract Data", "supplier", "Contract reference create for TEST Supplier 1", "Fri Jan 11 2019 13:29:02 GMT+0000 (Greenwich Mean Time)", "Fri Oct 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", "TEST Supplier 1", 123, 1000, "https://www.test.com/", true, "Fri Jan 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", attachments, "test comment 1", false);
        ContractData contractData2 = buildContractData(2L, "CONTRACT 2", "ABC123", "Contract Data", "items", "Contract reference create for TEST Supplier 2", "Fri Feb 11 2019 13:29:02 GMT+0000 (Greenwich Mean Time)", "Fri Sep 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", "TEST Supplier 2", 123, 1000, "https://www.test.com/", true, "Fri Jan 12 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", attachments, "test comment 2", false);
        ContractData contractData3 = buildContractData(3L, "CONTRACT 3", "GHI456", "Contract Data", "supplier", "Contract reference create for TEST Supplier 3", "Fri Mar 11 2019 13:29:02 GMT+0000 (Greenwich Mean Time)", "Fri Nov 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", "Supplier 3", 123, 2000, "https://www.test.com/", true, "Fri Feb 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", attachments, "test comment 3", true);
        ContractData contractData4 = buildContractData(4L, "CONTRACT 4", "JKL789", "Contract Data", "items", "Contract reference create for TEST Supplier 123", "Fri Feb 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", "Fri Feb 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", "TEST Supplier 123", 123, 12000, "https://www.test.com/", true, "Fri Mar 13 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", attachments, "test comment 4", true);
        ContractData contractData5 = buildContractData(5L, "CONTRACT 5", "MNO838", "Contract Data", "items", "Contract reference create for TEST Supplier 333", "Fri Oct 11 2019 13:29:02 GMT+0000 (Greenwich Mean Time)", "Fri Mar 11 2020 13:29:02 GMT+0000 (Greenwich Mean Time)", "Supplier 333", 123, 2500, "https://www.test.com/", true, "Fri Sep 11 2021 13:29:02 GMT+0000 (Greenwich Mean Time)", attachments, "test comment 5", false);
    ...
    ContractData buildContractData(Long id, String name, String reference, String type, String assignType, String description, String startDate, String endDate, String supplier, Integer supplierId, Integer targetSpend, String fileUrl, Boolean expiryNotification, String expiryNotificationFrom, List<Attachment> attachments, String comment, Boolean archive) {
        ...
        contractData.setArchive(archive);
        return contractData;
    }
